...
* [atcoder/ac-library](https://github.com/atcoder/ac-library) ⭐ 2,345 | 🐛 17 | 🌐 C++ | 📅 2025-05-01 - AtCoder 측에서 공식 제공하는 라이브러리로, 컨볼루션, 펜윅 트리, 느리게 갱신되는 세그먼트 트리, 강한 연결 요소 등 다양한 코드를 제공합니다.
...
* [lumirlumir/npm-bananass](https://github.com/lumirlumir/npm-bananass) ⭐ 49 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-11 - 백준, 코드포스 등 다양한 Node.js 문제 풀이 환경에서 사용할 수 있는 자바스크립트/타입스크립트 전용 프레임워크입니다.

## 문제 출제

* [MikeMirzayanov/testlib](https://github.com/MikeMirzayanov/testlib) ⭐ 1,734 | 🐛 33 | 🌐 C++ | 📅 2026-06-21 - 문제 출제 과정에서 문제 채점기, 데이터 검증기, 데이터 제너레이터 등을 만들때 도움이 되는 유틸리티를 모아놓은 라이브러리입니다.
...
* [ucpcc/ucpc2020-description-layout](https://github.com/ucpcc/ucpc2020-description-layout) ⭐ 3 | 🐛 0 | 🌐 TeX | 📅 2020-10-20 -  [olymp.sty](https://github.com/GassaFM/olymp.sty) ⭐ 126 | 🐛 3 | 🌐 C++ | 📅 2024-01-31, [SPC 2019](https://acm.sogang.ac.kr/spc/) 문제지 레이아웃 기반 문제 본문 템플릿입니다.
...
* [BaekjoonHub](https://github.com/BaekjoonHub/BaekjoonHub) ⭐ 967 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-08 - 백준 온라인 저지, 프로그래머스 등에서 맞았습니다를 받을 경우 해당 소스 코드를 열람해 복사한 후 GitHub에 올려주는 브라우저 확장입니다. ([Chrome](https://chrome.google.com/webstore/detail/ccammcjdkpgjmcpijpahlehmapgmphmk))
...
* [star0202/solvedac-cards](https://github.com/star0202/solvedac-cards) ⭐ 19 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-11 - 유저의 프로필, 푼 문제들의 티어 및 태그를 기반으로 한 예쁜 카드들을 만들어줍니다.
...
* [코딩테스트 대비 문제집 with Baekjoon](https://github.com/tony9402/baekjoon) ⭐ 6,408 | 🐛 6 | 🌐 C++ | 📅 2026-08-12 - 코딩 테스트 대비용 알고리즘 문제집입니다.
* [바킹독의 실전 알고리즘](https://github.com/encrypted-def/basic-algo-lecture) ⭐ 2,781 | 🐛 23 | 🌐 C++ | 📅 2026-01-27 - C++를 사용한 실전 알고리즘 강좌로, C/C++ 문법에 친숙한 상태에서 알고리즘 지식을 익히기에 좋도록 작성되었습니다.
