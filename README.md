...
* [atcoder/ac-library](https://github.com/atcoder/ac-library) ⭐ 2,357 | 🐛 18 | 🌐 C++ | 📅 2025-05-01 - AtCoder 측에서 공식 제공하는 라이브러리로, 컨볼루션, 펜윅 트리, 느리게 갱신되는 세그먼트 트리, 강한 연결 요소 등 다양한 코드를 제공합니다.
* [cheran-senthil/PyRival](https://github.com/cheran-senthil/PyRival) ⭐ 1,284 | 🐛 9 | 🌐 Python | 📅 2026-09-02 - Python으로 구현한 알고리즘 라이브러리 묶음입니다.
* [frozenca/BTree](https://github.com/frozenca/BTree) ⭐ 249 | 🐛 0 | 🌐 C++ | 📅 2024-10-29 - C++로 짠 범용, 헤더 온리, STL과 닮은 B-Tree 구현체입니다.

## 프레임워크

* [lumirlumir/npm-bananass](https://github.com/lumirlumir/npm-bananass) ⭐ 49 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-14 - 백준, 코드포스 등 다양한 Node.js 문제 풀이 환경에서 사용할 수 있는 자바스크립트/타입스크립트 전용 프레임워크입니다.

## 문제 출제

* [MikeMirzayanov/testlib](https://github.com/MikeMirzayanov/testlib) ⭐ 1,744 | 🐛 33 | 🌐 C++ | 📅 2026-08-27 - 문제 출제 과정에서 문제 채점기, 데이터 검증기, 데이터 제너레이터 등을 만들때 도움이 되는 유틸리티를 모아놓은 라이브러리입니다.
...
* [PENEKhun/Baekjoon-java-starter](https://github.com/PENEKhun/Baekjoon-java-starter) ⭐ 31 | 🐛 6 | 🌐 Java | 📅 2026-01-05 - IntelliJ 기반 Java 사용자를 위한 템플릿 생성 및 테스팅 서포트 도구
...
* [BaekjoonHub](https://github.com/BaekjoonHub/BaekjoonHub) ⭐ 970 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-12 - 백준 온라인 저지, 프로그래머스 등에서 맞았습니다를 받을 경우 해당 소스 코드를 열람해 복사한 후 GitHub에 올려주는 브라우저 확장입니다. ([Chrome](https://chrome.google.com/webstore/detail/ccammcjdkpgjmcpijpahlehmapgmphmk))
...
* [토마토 예측기](https://github.com/kiwiyou/tomato-predictor) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2024-03-01 - solved.ac 아레나 레이팅 변화를 예측합니다. ([Chrome](https://chromewebstore.google.com/detail/토마토-예측기/flknggeljmkhfhehgflcagoffnpnjcgf), [Firefox](https://addons.mozilla.org/firefox/addon/tomato-predictor/))
* [random-ac](https://github.com/Bubbler-4/random-ac) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2024-03-28 - 백준 그룹 연습에서 랜덤 디펜스를 쉽게 만들어주는 확장입니다. ([Chrome](https://chromewebstore.google.com/detail/randomac/kdodhnnpnikopmoafeahigimagjhooba), [Firefox](https://addons.mozilla.org/ko/firefox/addon/random-ac/))

## 서비스

* [mazassumnida/mazassumnida](https://github.com/mazassumnida/mazassumnida) ⭐ 652 | 🐛 0 | 🌐 Python | 📅 2026-04-13 - 레이팅, 푼 문제 수, 티어 정보, 자체 티어 아이콘 등을 담은 예쁜 [solved.ac][] 정보 기반 뱃지/배너를 만들어줍니다.
* [mazassumnida/mazandi](https://github.com/mazassumnida/mazandi) ⭐ 195 | 🐛 0 | 🌐 Python | 📅 2023-05-04 - 예쁜 [solved.ac][] 잔디 배너를 만들어줍니다.
...
* [star0202/solvedac-cards](https://github.com/star0202/solvedac-cards) ⭐ 19 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-15 - 유저의 프로필, 푼 문제들의 티어 및 태그를 기반으로 한 예쁜 카드들을 만들어줍니다.
...
* [testcase.ac](https://testcase.ac/) - 백준 코드의 반례를 찾을 수 있도록 정답 코드, 제너레이터, 제출 사례를 모아두는 서비스입니다. ([Chrome 확장 프로그램](https://chromewebstore.google.com/detail/testcaseac/idemfboidcafddhdkhbniobcioacjfkm))
* [CodeMate](https://codemate.kr/) - solved.ac 기반 문제 추천, 진도 관리, 이메일 알림으로 팀 단위 백준 스터디를 운영할 수 있는 플랫폼입니다.
* [Blobnom](https://blobnom.xyz/) - 백준 문제를 여러 사람과 땅따먹기 형식으로 풀어볼 수 있는 대전/연습 서비스입니다.
...
* [제 1회 구데기컵, 진짜 최종 구데기컵 2018](https://github.com/ghudegy/2018) ⭐ 35 | 🐛 0 | 🌐 Python | 📅 2023-03-13
* [진짜 최종 구데기컵 2 2](https://github.com/ghudegy/2022) ⭐ 21 | 🐛 2 | 📅 2022-09-27
* [EtvycAuRLZpb6hhe86x0](https://github.com/ghudegy/2021) ⭐ 8 | 🐛 0 | 📅 2022-03-22
...
* [kiwiyou/basm-rs](https://github.com/kiwiyou/basm-rs) ⭐ 142 | 🐛 7 | 🌐 Rust | 📅 2026-06-15 - 정적 링크한 no-libc, no-std Rust 프로그램 바이너리를 C 프로그램으로 번역해줍니다. 미리 구현해 제공하는 라이브러리는 물론, 조건에 맞는 외부 Rust 라이브러리도 사용할 수 있으며 빠릅니다.
* [xvzc/boj-cli](https://github.com/xvzc/boj-cli) ⚠️ Archived -  백준 온라인 저지 커맨드 라인 인터페이스
* [Bubbler-4/gaboja](https://github.com/Bubbler-4/gaboja) ⭐ 9 | 🐛 0 | 🌐 Rust | 📅 2026-03-25 - 백준 문제 풀이를 편리하게 만들어주는 CLI 도구 묶음입니다.
* [duqrldudgns/PS\_CounterEx\_Generator](https://github.com/duqrldudgns/PS_CounterEx_Generator) ⭐ 5 | 🐛 1 | 🌐 C++ | 📅 2025-09-17 - 맞았습니다가 뜨는 C++ 코드와 틀렸습니다가 뜨는 C++ 코드가 주어질 때 무차별 대입 기법으로 반례를 찾아냅니다.
* [zshchun/bojtools](https://github.com/zshchun/bojtools) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-04-20 - 백준 온라인 저지 및 [solved.ac][] 전용 CLI 도구 묶음입니다.

## 학습

* [코딩테스트 대비 문제집 with Baekjoon](https://github.com/tony9402/baekjoon) ⭐ 6,418 | 🐛 6 | 🌐 C++ | 📅 2026-09-15 - 코딩 테스트 대비용 알고리즘 문제집입니다.
